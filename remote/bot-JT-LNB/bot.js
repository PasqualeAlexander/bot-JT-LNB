...
const roomConfig = {
    ...
    token: "thr1.AAAAAGjxdrjn2kW2oFrqPQ.Z3XXrpEbI40", // Token actualizado
    ...
    try {
        ...
        try {
            await page.evaluate((codigo) => {
                ...
                try {
                    // Handlers globales de errores para capturar detalles con línea/archivo
                    ...
                    // Inyectar el código como <script> con sourceURL para mejores trazas
                    try {
                        const script = document.createElement('script');
                        script.type = 'text/javascript';
                        script.text = codigo + '\n//# sourceURL=BOTLNBCODE.js';
                        (document.head || document.documentElement).appendChild(script);
                        console.log('✅ DEBUG: Script inyectado vía script tag');
                    } catch (parseErr) {
